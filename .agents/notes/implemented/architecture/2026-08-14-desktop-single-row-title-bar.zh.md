...
> 范围：桌面应用外壳——Windows 自绘单行标题栏、沙箱 preload 桥与窗口菜单 IPC。承接 [系统托盘与关闭隐藏](2026-08-14-desktop-tray-and-close-to-tray.zh.md) 决策（已移除默认菜单栏并定义托盘归属）。
