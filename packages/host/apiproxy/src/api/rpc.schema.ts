...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('not-archived'), message: z.string(), details: z.object({ sessionId: z.string() }) }),
  ...
  z.object({ code: z.literal('file-picker-unavailable'), message: z.string(), details: z.object({ capability: z.string() }) }),
