...
export interface RpcMethodMap {
  ...
  'host.pickFiles': HostApi['pickFiles']
  'host.locateFiles': HostApi['locateFiles']
  ...
  'workspace.restoreSession': WorkspaceApi['restoreSession']
  'workspace.deleteSession': WorkspaceApi['deleteSession']
  'workspace.listArchived': WorkspaceApi['listArchived']
