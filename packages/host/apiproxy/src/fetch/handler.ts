...
import {
  ...
  sessionDeleteMessageRequestSchema,
  sessionEditMessageRequestSchema,
...
import {
  ...
  hostListDirectoryRequestSchema, hostLocateFilesRequestSchema, hostOpenPathRequestSchema,
  hostPickDirectoryRequestSchema, hostPickFilesRequestSchema,
...
import {
  ...
  workspaceListArchivedRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'session.deleteMessage': { schema: sessionDeleteMessageRequestSchema, invoke: (api, r) => api.sessions.deleteMessage(r) },
  'session.editMessage': { schema: sessionEditMessageRequestSchema, invoke: (api, r) => api.sessions.editMessage(r) },
  ...
  'host.pickFiles': { schema: hostPickFilesRequestSchema, invoke: (api, r, signal) => api.host.pickFiles(r, signal) },
  'host.locateFiles': { schema: hostLocateFilesRequestSchema, invoke: (api, r, signal) => api.host.locateFiles(r, signal) },
  ...
  'workspace.restoreSession': { schema: workspaceRestoreSessionRequestSchema, invoke: (api, r) => api.workspace.restoreSession(r) },
  'workspace.deleteSession': { schema: workspaceDeleteSessionRequestSchema, invoke: (api, r) => api.workspace.deleteSession(r) },
  'workspace.listArchived': { schema: workspaceListArchivedRequestSchema, invoke: (api, r) => api.workspace.listArchived(r) },
