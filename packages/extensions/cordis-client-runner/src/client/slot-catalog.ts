...
export const CLIENT_SLOT_API: readonly ClientSlotEntry[] = [
  ...
  },
  {
    ...
    occupants: [
      ...
      'client-ui-settings-plugins DescribeImageCard id \'describe-image\'',
  ...
  },
  {
    ...
    occupants: [
      'client-ui-settings-plugin-control PluginControlSettingsTab id \'controls\'',
      'client-ui-settings-plugin-installer PluginInstallerTab id \'installer\'',
  ...
  },
  {
    ...
    kind: 'single',
    scope: 'root',
    summary: 'The remote-control seat in the sidebar foot, its own row above the settings trigger.',
    doc: 'The remote-control seat in the sidebar foot, its own row above the\nsettings trigger. Declared by this package\'s \'sidebar\' entry; the\nmobile remote plugin registers its pairing trigger here. The sidebar\npasses only its column state.',
    registerOptions: [],
    ownerProps: [
