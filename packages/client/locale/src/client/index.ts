 ...
 * registered language (and for non-browser runs), and the dictionary consulted
 ...
 * direction can leave a key unresolved; the residual case points at Chinese
 * because this product's readers default to Chinese.
 */
export const FALLBACK_LOCALE: BuiltInLocaleId = 'zh'
