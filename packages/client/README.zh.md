...
| [`ui-settings-plugin-installer/`](ui-settings-plugin-installer/README.md) | 向“插件”设置贡献合并后的插件列表标签页（用户插件、预装产品、只读内置条目）。 |
| [`ui-notifications/`](ui-notifications/README.md) | 为授权等待与任务完成弹出系统通知，并提供“通知”设置分区。 |
