...
export interface ISession {
   ...
   */
  deleteMessage(seq: number): Promise<RemoteResult<{ start: number; end: number; deletedSeqs: number[] }>>
  /**
   ...
   */
  editMessage(seq: number, content: PromptContentPart[]): Promise<RemoteResult<{ accepted: true }>>
}
