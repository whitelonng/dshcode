...
This guide assumes you started the Web UI through the [root README](../../../README.md#quick-start). Model changes take effect on the next request without restarting the server.
